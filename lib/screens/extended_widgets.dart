...
class _ExtendWidgetState extends ConsumerState<ExtendWidget> {
  ...
  void initState() {
    ...
    if (widget.widgetType == 'humidity_widget') {
      ...
      builder = (raw, timeUnit) => const Center(child: Text('Unknown widget type'));
      extendedTitle = 'Error';
    }
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  EdgeInsetsDirectional itemMargin = EdgeInsetsDirectional.only(
                    start: index == 0 ? 10 : 0,
  ...
  Widget buildVisibilityExtended(Map<String, dynamic> raw, UnitSettingsNotifier units) {
    ...
    final currentVisibility =
        hourly['visibility'][getStartIndex(weather['utc_offset_seconds'].toString(), hourlyTime)] ??
            0.0;
    final visibilityUnit = units.visibilityUnit;
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text(
                            localizeVisibilityUnit(visibilityUnit, context.locale),
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).colorScheme.onTertiaryContainer,
                            ),
