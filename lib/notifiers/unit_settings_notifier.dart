...
class UnitSettingsNotifier extends ChangeNotifier {
  ...
  Future<void> _loadAllUnits() async {
    _tempUnit =
        PreferencesHelper.getString("selectedTempUnit") ?? _tempUnit;
    _windUnit =
        PreferencesHelper.getString("selectedWindUnit") ?? _windUnit;
    _visibilityUnit =
    ...
    _precipitationUnit =
        PreferencesHelper.getString("selectedPrecipitationUnit") ??
            _precipitationUnit;
    _pressureUnit = PreferencesHelper.getString("selectedPressureUnit") ??
        _pressureUnit;
    _timeUnit =
        PreferencesHelper.getString("selectedTimeUnit") ?? _timeUnit;
    _aqiUnit = PreferencesHelper.getString("selectedAQIUnit") ?? _aqiUnit;
    _useDeviceCompass = PreferencesHelper.getBool("useDeviceCompass") ??
        _useDeviceCompass;
